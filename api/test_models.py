...
from api.models import User, Project, ProjectType, FindingData, FindingTemplate
    ...
    example_user = """
{
    ...
    def test_project_parsing(self):
        ...
        self.assertEqual(test_project.id, "4cf78324-8502-4fb0-936a-724892d3c539")
        self.assertEqual(
    ...
    def test_finding_template_parsing(self):
        ...
        self.assertEqual(test_finding_template.data.title, "SQL Injection (SQLi)")
