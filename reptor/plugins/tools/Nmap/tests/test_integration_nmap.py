...
class TestIntegrationNmap(object):
    def test_nmap_note(self, notes_api):  # noqa: F811
        ...
        nmap_note = notes_api.get_note_by_title("Nmap", parent_title=None)
        ...
        ip_note = notes_api.get_note_by_title(
            "142.250.180.228", parent_title="Nmap"
        )
        ...
        ip_note = notes_api.get_note_by_title("34.249.200.254", parent_title="Nmap")
        note_lines = ip_note.text.splitlines()
        assert (
