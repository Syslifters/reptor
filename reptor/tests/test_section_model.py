...
class TestSectionModelParsing:
    ...
    def test_section_data(self):
        ...
        section_data = SectionData(section_raw.data, project_design.report_fields, strict_type_check=True)
